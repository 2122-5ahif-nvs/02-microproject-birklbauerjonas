...
public class InvoiceTests {
    ...
    void toString_IsEqual_True() {
        ...
        assertThat(invoice.toString())
                .isEqualTo("Invoice{dateOfPurchase=2020-10-22, customer=Customer{name='Jonas Birklbauer', street='Herrenstraße', zipCode='4020', city='Linz', phoneNumber='06501235467'}}");
